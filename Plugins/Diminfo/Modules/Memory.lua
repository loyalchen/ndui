...
if cfg.Memory == true then
	...
	local Total, tTotal, Mem, MEMORY_TEXT, Memory, maxAddOns, statColor
	...
	Stat:SetScript("OnEnter", function(self)
		...
		GameTooltip:AddDoubleLine(format("%s:",ADDONS),formatMem(Total), 0, 0.6, 1, .6, .8, 1)
		GameTooltip:AddLine(" ")
